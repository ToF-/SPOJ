...
T{
    ...
    0 VERTEX^ EDGE-LIMITS NIP
    DUP EDGE->COST 100 ?S CELL+ EDGE->COST 300 ?S
}T
T{
    0 VERTEX^ VERTEX->EDGES CELL+
    DUP EDGE->DESTINATION 2 ?S EDGE->COST 300 ?S
    ...
    DUP EDGE->DESTINATION 0 ?S EDGE->COST 100 ?S
    ...
    3 VERTEX^ VERTEX->EDGES
    DUP EDGE->DESTINATION 1 ?S EDGE->COST 400 ?S
