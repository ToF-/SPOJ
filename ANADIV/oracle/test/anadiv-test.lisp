...
(define-test max-anagram-of-single-digit-prefix-no-strict
             ...
             (assert-equal 8874312 (max-anagram-of 2 1 1234788 nil))
             )
...
(define-test max-anagram-of-multi-digit-prefix-strict
             ...
             (assert-equal 0 (max-anagram-of 147 3 8147 t))
             (assert-equal 18147 (max-anagram-of 147 3 81147 t))
             )

(define-test max-anagram-of-all-with-empty-multiples-no-strict
             (assert-equal 8740 (max-anagram-of-all () 0 8740 nil))
             )

(define-test max-anagram-of-all-with-empty-multiples-strict
             (assert-equal 8704 (max-anagram-of-all () 0 8740 t))
             )

(define-test max-anagram-of-all-a-list-of-multiples-no-strict
             (assert-equal 8874312 (max-anagram-of-all *multiples-2* 1 1234788 nil))
             (assert-equal 8504 (max-anagram-of-all *multiples-8-3* 3 4805 nil))
             (assert-equal 984 (max-anagram-of-all *multiples-4-2* 2 489 nil))
             )

(define-test max-anagram-of-all-a-list-of-multiples-strict
             (assert-equal 948 (max-anagram-of-all *multiples-4-2* 2 984 t))
             (assert-equal 9784 (max-anagram-of-all *multiples-2* 1 9874 t))
             (assert-equal 0 (max-anagram-of-all *multiples-2* 1 7772 t))
             )

(define-test max-anagram-of-all-no-matching-multiples
             (assert-equal 0 (max-anagram-of-all *multiples-8-3* 3 777777 t))
             )
...
(define-test max-anagram-multiple-of-6-strict
             (assert-equal -1 (max-anagram-multiple 6 6 :strict t))
             (assert-equal 372 (max-anagram-multiple 6 732 :strict t))
             )
